...
2. 提供官方链接，用中文概括具体用途。必要时说明产品形态，不使用「最强」「生产级」「完全安全」等无法由条目证明的措辞。
...
分类内按显示名称排序：拉丁字母名称不区分大小写，中文名称按拼音处理。排序只便于查找，不代表推荐次序。工具放在用途分类；协议、教程、论文和资源索引放在对应资源分类。同一研究的论文与配套仓库可合并为一个条目。
