...
- [Team Knowledge and Business Assistants](#team-knowledge-and-business-assistants)
- [Team Workspaces and Task Collaboration](#team-workspaces-and-task-collaboration)
- [AI in Chat and Meetings](#ai-in-chat-and-meetings)
- [Whiteboards and Visual Collaboration](#whiteboards-and-visual-collaboration)
- [Agent Assistants and Session Management](#agent-assistants-and-session-management)
...
- [Memory and Shared Team Practices](#memory-and-shared-team-practices)
- [Evaluation and Observability](#evaluation-and-observability)
- [Model Access and Runtime Infrastructure](#model-access-and-runtime-infrastructure)
- [Protocols and Conventions](#protocols-and-conventions)
- [Practice and Learning Resources](#practice-and-learning-resources)
...
## Team Knowledge and Business Assistants

Find organizational knowledge, prepare documents, and connect AI to existing business processes.
...
## Team Workspaces and Task Collaboration

Delegate, track, and review agent work together, using integrations with existing platforms or dedicated workspaces.
...
## AI in Chat and Meetings

Bring assistants into existing communication channels; messaging, integration, and execution services have different responsibilities.
...
Turn AI drafts into visual artifacts that people can discuss, edit, or embed in products.
...
## Agent Assistants and Session Management

Execute coding and other tasks, or manage agent sessions, workspaces, and handoffs; personal workspaces do not automatically provide multi-user access controls.
...
Compose models, tools, steps, and state through visual platforms or frameworks to build AI applications.
...
Prepare source files for retrieval and model input.
...
## Memory and Shared Team Practices

Store, organize, or distribute information and procedures for later work; distinguish personal memory, team knowledge, and configuration distribution.
...
Inspect execution, compare changes with test cases, or add specialized content checks; evaluations need task-specific criteria.
...
## Model Access and Runtime Infrastructure

Unify model access, use cloud platforms, or provision execution environments; gateways, hosted agents, and sandboxes serve different needs.
...
Standardize connections, handoffs, and records through formats implemented by individual tools.
...
Build repeatable practices for tools, team configuration, long-running tasks, and human review.
...
Support team learning and improvement hypotheses; interpret research within its original experimental conditions.
...
Discover additional candidates; inclusion in a directory does not validate every listed project.
